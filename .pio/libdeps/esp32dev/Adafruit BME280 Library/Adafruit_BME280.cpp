...
/*!
 * @brief Prints to the serial monitor initial temperature reading
 */
void Adafruit_BME280::readInitialTemperature()
{
...
/**************************************************************************/
/*! @erielC
    @brief Verifies the I2C connection between sensor and computer
    @param address BME280 I2C address
    @return message saying that the I2C connection is established
*/
/**************************************************************************/
void Adafruit_BME280::verifyConnection()
{
  u_int8_t address = BME280_ADDRESS;
  ...
  {
    Serial.println("Failed to connect to the BME280");
